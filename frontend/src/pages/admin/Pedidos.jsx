...
export default function Pedidos() {
  ...
  function handleApagarPedido(pedido) {
    setPedidoSelecionado(pedido);
        ...
        >
          ...
          >
            ...
            >
              ...
              <h4>
                {pedidoVer?.titulo ?? "Título do pedido"}
              </h4>
              ...
              >
                ...
                <p>
                  {pedidoVer?.descricao ?? "Sem descrição disponível."}
                </p>
              </div>
              ...
              <button
                ...
                onClick={() => {
                  if (pedidoSelecionado?.id) {
                    apagarPedido(pedidoSelecionado.id);
                  }
                }}
              >
                Apagar
        ...
        <div className="row g-3">
          ...
          <div className="col-lg-3">
            ...
            >
              ...
              <option value="maior-id">
                Mais recentes
              </option>
              <option value="menor-id">
                Mais antigos
              </option>
            </select>
          </div>
