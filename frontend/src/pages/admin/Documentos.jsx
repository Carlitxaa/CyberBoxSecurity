  ...
  return (
    ...
    >
      ...
      >
        ...
        <h5>Arraste ficheiro para aqui ou clique para selecionar</h5>

        <p style={{ color: "#7d7d7d" }}>
          Suporta PDF, DOCX, imagens e outros formatos (max 10MB)
        </p>

        <button
          className="btn"
          style={{ background: "#12C4EB", color: "white", borderRadius: "30px" }}
        >
