...
export default function Utilizadores() {
  ...
  const utilizadoresFiltrados = utilizadores.filter((user) => {
    ...
    const estadoMatch =
      filtroEstado === "Todos os Estados" || user.estado === filtroEstado;

    return pesquisaMatch && tipoMatch && estadoMatch;
  });
  ...
  return (
    ...
    >
      ...
      <div className="row g-4 mb-4">
        {[
          ...
          },
          {
            ...
            value: utilizadores.filter((u) => u.tipo === "Administrador").length,
          },
        ].map((card, index) => (
      ...
      >
        ...
        >
          <div className="col-3 text-start">Utilizador</div>
          ...
          <div className="col">Último Acesso</div>

          <div className="col">Ações</div>
        </div>

        {utilizadoresFiltrados.map((user, index) => (
          <div
            key={index}
            ...
            style={{
              padding: "22px 30px",
              borderBottom:
                index !== utilizadoresFiltrados.length - 1
                  ? "2px solid #12C4EB"
                  : "none",
            }}
          >
              ...
              <div className="d-flex align-items-center gap-3">
                <div
                  style={{
                    ...
                    height: "50px",
                    borderRadius: "50%",
                    background: getTipoColor(user.tipo),
                    display: "flex",
                    alignItems: "center",
                ...
                <div className="text-start">
                  ...
                  <small style={{ color: "#8b8b8b" }}>{user.email}</small>
                </div>
              </div>
            </div>

            <div className="col">{user.empresa}</div>
            ...
            <div className="col">
              <span
                style={{
                  background:
                    user.estado === "Ativo" ? "#42E66E" : "#F87171",
                  color: "white",
                  padding: "6px 14px",
                  borderRadius: "20px",
                }}
